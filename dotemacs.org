                     ...
                     (let* ((active (powerline-selected-window-active))
                            ...
                            (lhs (list
                                  ...
                                  (funcall separator-left face
                                           (setq face (thblt/powerline-get-face "persp" (unless t "bad"))))
                                  ;; Look here =======================================> ^@FIXME
                                  ;; (this used to be useful when using
                                  ;; persp-mode to indicate that current
                                  ;; buffer wasn't in perspctive.  It's
                                  ;; now pointless.)
                                  (powerline-raw
                                   (w server-name)
                                   face)

  ...
  (defun thblt/powerline-set-faces (&rest args)
    (let* ((default-bg (face-attribute 'default :background))
      ...
      (face-spec-set 'thblt/powerline-window-information-face
                     `((t :background "black" :foreground "orange" :weight bold)))
      ...
      (face-spec-set 'thblt/powerline-persp-face
                     `((t :background ,default-fg :foreground "DarkViolet" :weight bold)))
                   ...
                   (cl-flet ((w (str) (concat " " str " ")))
                     (let* ((active (powerline-selected-window-active))
                            ...
                            (lhs (list
                                  ...
                                  (funcall separator-left 'default face1)

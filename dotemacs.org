...
This section sets up the very general Emacs configuration.  It's a bit messy, since it's mostly made up of all the bits that don't fit anywhere.
...
** Standard keybindings remappings
